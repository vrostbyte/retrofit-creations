/*
  Signup page — light-body theme (PRD v1.2.0).
*/
"use client";
      ...
      <div className="w-full max-w-md">
        <div className="bg-white border border-[#E8E8E8] rounded-xl p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5" noValidate>
            <Input label="Full Name" name="fullName" value={form.fullName} onChange={(e) => setField("fullName", e.target.value)} error={errors.fullName} placeholder="Hailie Smith" required />
            ...
            <Input label="Password" name="password" type="password" value={form.password} onChange={(e) => setField("password", e.target.value)} error={errors.password} placeholder="At least 8 characters" required />
            <Input label="Confirm Password" name="confirmPassword" type="password" value={form.confirmPassword} onChange={(e) => setField("confirmPassword", e.target.value)} error={errors.confirmPassword} placeholder="Repeat your password" required />
          ...
          <p className="text-center text-sm text-gray-500 font-body mt-6">
            ...
            <Link href="/account/login" className="text-brand-blue hover:underline font-semibold">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
